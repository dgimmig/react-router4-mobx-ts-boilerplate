...
export default class Home extends React.Component<{ store?: AppState }, {}> {
                ...
                <main>
                    ...
                    <div className="boilerplate-item">
                        ...
                        <div className="boilerplate-item-content">
                            ...
                            <p>React Router is a declarative way to render, at any location,
                                any UI that you and your team can think up.</p>
                        </div>
                    </div>
                    <div className="boilerplate-item">
                        ...
                        <div className="boilerplate-item-content">
                            ...
                            <p>Webpack takes modules with dependencies
                                and generates static assets representing those modules.</p>
                        </div>
                    </div>
